...
//Вывод на экран строки определённой ширины, если больше - то не выводятся
    ...
    void print_lcd(const Fnt _font_height,const short x,const short y,const std::string& strIn,const bool transparency=false, unsigned short width=MAX_WIDTH_LCD, const unsigned char _color=DEFAULT_COLOR);
