...
int main(int argc, char *argv[])
{
    ...
    View_LCD* m_View1=new View_LCD(900,32);
	m_View1->print_lcd(32,0,0,"00:00:00 Это очень длинная строка. This string is very long");
	m_View1->line(0,0,890,30);

    View_LCD* m_View3=new View_LCD(500,17);//Нужна функция вычисляющая ширину строки
	m_View3->print_lcd(16,0,0," Валек красавец в натуре. Валек красавец в натуре.");
	//m_View1->line(0,0,890,30);
    ...
    m_View_LCD->print_lcd(8,0,0,"1234567890",true);
    m_View_LCD->print_lcd(16,0,8,"VALEK красавец",true);
    m_View_LCD->print_lcd(24,0,24,"1DFG",true);
	...
	for(int i=0;i<1100;i++)
	{
	    ...
	    if (last_sec!=now->tm_sec)//Вызывать нужно 1 раз в секунду
	    {
			...
			m_View1->print_lcd(32,0,0,buffer);
			last_sec=now->tm_sec;
		}
		step+=sign_step;
