...
OBJS = main.o I2CBus.o sSymbol.o Font.o Lib_Fonts.o Row_LCD.o View_LCD.o LCD_TIC149.o LCD_TIC149_Fast.o Weather.o EasyBMP.o Utils.o
#ODIR = obj
...
Lib_Fonts.o: Lib_Fonts.cc Lib_Fonts.h
	g++ -c -std=c++11 Lib_Fonts.cc Lib_Fonts.h
